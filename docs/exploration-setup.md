...
**Segments** are created in the Variables column, applied in the Settings column. Segments define a subset of users, sessions or events, and can be applied to one or more tabs within an exploration.
